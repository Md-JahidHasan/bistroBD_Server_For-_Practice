...
const stripe = require("stripe")(
  "sk_test_51M6CREBmdpOIAhB7cVB2Jg6rCCVDOnQz6gi18oPyWl5TGJfzFHfeXqmNnErjGWCVnaeSLi2y26M1WxYcwhj0QVj400hUI0yst6"
);
...
app.listen(port, () => {
  console.log(`Bristro boss server is running on port ${port}`);
});
